...
import static df.idgbusiness.itfitness.CommonUtilities.DISPLAY_MESSAGE_ACTION;
import static df.idgbusiness.itfitness.CommonUtilities.EXTRA_COUNT;
import static df.idgbusiness.itfitness.CommonUtilities.EXTRA_MESSAGE;
import static df.idgbusiness.itfitness.GCMIntentService.count;
...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        task.execute(new String[] { "placebo" });
    ...
    /*Removing from Main Task*/
    private class InitializeDBTask extends AsyncTask<String, Void, String> {
